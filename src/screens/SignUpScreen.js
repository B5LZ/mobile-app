          ...
          <View style={styles.content}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.rowGroup}>
                <View style={[styles.inputShell, styles.rowItem]}>
                ...
                <View style={[styles.inputShell, styles.ageItem]}>
                  <TextInput
                    value={age}
                    editable={false}
                    placeholder="Age"
                    placeholderTextColor={ThemeColor.PLACEHOLDER}
                    style={[styles.inputInner, styles.ageInput]}
                  />
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  rowItem: { flex: 3, marginBottom: 14 },
  ageItem: { flex: 1, marginBottom: 14 },
